"""Global configuration for Hindsight-Claude-Agent-SDK integration."""
...
@dataclass
class HindsightClaudeAgentSDKConfig:
    """Connection and default settings for the Claude Agent SDK integration.
...
_global_config: HindsightClaudeAgentSDKConfig | None = None
...
def configure(
    ...
    Returns:
        The configured HindsightClaudeAgentSDKConfig.
    """
    ...
    _global_config = HindsightClaudeAgentSDKConfig(
...
def get_config() -> HindsightClaudeAgentSDKConfig | None:
