...
Mirrors `hindsight-integrations/cursor-cli/.../lib/client.py` with the
User-Agent string rebranded for the Copilot CLI integration.
"""
...
USER_AGENT = f"hindsight-copilot-cli/{_plugin_version()}"
...
class HindsightClient:
    ...
    def retain(
        ...
        (e.g. "copilot-cli" vs manual retains).
        """
