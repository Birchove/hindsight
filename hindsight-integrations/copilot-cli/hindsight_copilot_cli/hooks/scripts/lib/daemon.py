...
Mirrors `hindsight-integrations/cursor-cli/hindsight_cursor_cli/hooks/scripts/lib/daemon.py`
with the profile name rebranded for the Copilot CLI integration. Manages three
connection modes:
...
Daemon state is tracked via files in ~/.hindsight/copilot-cli/state/.
"""
