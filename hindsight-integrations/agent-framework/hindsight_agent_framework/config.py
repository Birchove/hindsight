"""Global configuration for the Hindsight Agent Framework integration."""
...
@dataclass
class HindsightAgentFrameworkConfig:
    """Connection and default settings for the Agent Framework integration.
    ...
    Attributes:
        ...
        recall_tags: Default tags to filter when recalling memories.
    ...
    context: str = "agent-framework"
    mission: Optional[str] = None
    verbose: bool = False


_global_config: Optional[HindsightAgentFrameworkConfig] = None
...
def configure(
    ...
    Args:
        ...
        recall_tags: Default tags to filter recall.
    ...
    Returns:
        The configured HindsightAgentFrameworkConfig.
    """
    ...
    _global_config = HindsightAgentFrameworkConfig(
...
def get_config() -> Optional[HindsightAgentFrameworkConfig]:
