"""Global configuration for Hindsight-SmolAgents integration."""
...
@dataclass
class HindsightSmolAgentsConfig:
...
_global_config: HindsightSmolAgentsConfig | None = None
...
def configure(
    ...
    Returns:
        The configured HindsightSmolAgentsConfig.
    """
    ...
    _global_config = HindsightSmolAgentsConfig(
...
def get_config() -> HindsightSmolAgentsConfig | None:
