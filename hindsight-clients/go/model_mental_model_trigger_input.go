...
func (o *MentalModelTriggerInput) GetRefreshCron() string {
...
func (o *MentalModelTriggerInput) GetRefreshCronOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MentalModelTriggerInput) HasRefreshCron() bool {
...
func (o *MentalModelTriggerInput) SetRefreshCron(v string) {
	o.RefreshCron.Set(&v)
}
// SetRefreshCronNil sets the value for RefreshCron to be an explicit nil
func (o *MentalModelTriggerInput) SetRefreshCronNil() {
